...
SECRET_KEY = 'django-insecure-^u%h3k8&@vs70+pc2oyws_u*4jawk6^x!i7^e8*l%#6ke6zhbk'
...
LOGGING = {
    ...
    'handlers': {
        'stdout_debug': {
            ...
            'formatter': 'stdout_debug',
        },
        'stdout_warning': {
            'level': 'WARNING',
            'class': 'logging.StreamHandler',
            'filters': ['require_debug_true'],
            'formatter': 'stdout_warning',

        },
        'stdout_error_&_critical': {
            'level': 'ERROR',
            'class': 'logging.StreamHandler',
            'filters': ['require_debug_true'],
            'formatter': 'stdout_error_critical',
        },
        'general': {
            'level': 'INFO',
